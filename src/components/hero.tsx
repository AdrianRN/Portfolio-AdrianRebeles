			...
			<div class='px-5 flex text-black flex-col-reverse sm:flex-row justify-center md:gap-10 items-center max-w-4xl mx-auto h-full'>
				<div>
					...
					<div class='flex justify-between items-center mt-4 md:mt-0'>
						...
						<a
							href='/docs/CV-AdrianRebeles.pdf'
							title='Download resume'
							download={true}
							target='_blank'
							class='text-step--1 font-lato flex shadow-lg px-2 py-2 items-center gap-2 rounded-md bg-gradient-to-r from-blue-500 to bg-cyan-500 text-white hover:shadow-xl dark:bg-blue-600 dark:border-none dark:hover:bg-blue-700 dark:hover:text-white disabled:opacity-50 transition-shadow ease-in-out duration-300'
						>
							<p>Download resume</p>
							<svg
